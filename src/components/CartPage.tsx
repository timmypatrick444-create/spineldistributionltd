    ...
    <div className="max-w-7xl mx-auto px-4 py-8 text-gray-900">
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          className="text-xs font-semibold text-[#007185] hover:text-[#c45500] hover:underline flex items-center gap-1"
        >
      ...
      {cartItems.length === 0 ? (
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-12 text-center shadow-xs space-y-4">
          ...
          <div className="pt-2">
            <button
              onClick={onNavigateCatalog}
              className="bg-[#ffd814] hover:bg-[#f7ca00] text-[#0f1111] font-bold py-2.5 px-8 rounded-full text-xs shadow-xs transition-colors"
            >
              Shop All Products
            </button>
          </div>
                    ...
                    <div className="flex items-center gap-4 pt-3 flex-wrap">
                      <div className="flex items-center border border-gray-300 rounded bg-gray-50">
                        <button
                          ...
                          className="px-2.5 py-1 text-gray-600 hover:bg-gray-200 transition-colors"
                      ...
                      <button
                        ...
                        className="text-xs text-[#007185] hover:text-[#c45500] hover:underline flex items-center gap-1 font-medium"
                      >
          ...
          <div className="lg:col-span-4">
            <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-xs space-y-5 sticky top-24">
              ...
              <button
                ...
                className="w-full bg-[#ffd814] hover:bg-[#f7ca00] text-[#0f1111] font-bold py-3 px-4 rounded-full text-xs shadow-xs transition-colors flex items-center justify-center gap-2"
              >
      ...
      {recommendedProducts.length > 0 && (
        <div className="mt-14 bg-white p-6 rounded-lg border border-gray-200 shadow-xs">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
            {recommendedProducts.slice(0, 12).map((prod) => (
              <div
                key={prod.id}
              ...
              >
                ...
                >
                  ...
                  <div className="flex items-center text-amber-500 text-[10px]">
                    ...
                    <span className="ml-1 text-gray-500">({prod.reviewsCount})</span>
                  </div>
                ...
                <div className="pt-3 mt-2 border-t border-gray-100">
                  <button
                    ...
                    className="w-full bg-[#ffd814] hover:bg-[#f7ca00] text-[#0f1111] font-bold py-1.5 px-2 rounded-full text-[11px] transition-colors shadow-2xs"
                  >
                    Add to Cart
                  </button>
                </div>
